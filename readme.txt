...
#### Version 1.4.11 (August 2015)

- Fix: Date and time picker should be working fine again. Fixes https://github.com/bonny/WordPress-Simple-Fields/issues/105 and possible more.
- Fix: Remove a console.log what was highly annoying.
- Fix: XSS vulnerability for logged in users
